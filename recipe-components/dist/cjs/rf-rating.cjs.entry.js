...
const RfRating = class {
    ...
    render() {
        ...
        for (let i = 1; i <= this.max; i++) {
            ...
            stars.push(index.h("span", { class: `star star-${starType}`, key: i }, "\u2605"));
        }
        return (index.h("div", { key: 'c051cf5b1fdfaf522d3c87992ba0556eb0293b46', class: "rating-wrapper" }, index.h("div", { key: 'c22e0585efe69d4b49b2e11d71c84765a62a01c1', class: "stars-container" }, stars), this.showLabel && index.h("span", { key: '77f373f1b2e66d343d94a5ef662e0f16c86fb8f9', class: "rating-number" }, ratingValue.toFixed(1))));
    }
};
RfRating.style = rfRatingCss();

exports.rf_rating = RfRating;
